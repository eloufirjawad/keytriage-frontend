  ...
  return (
    <Box sx={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', p: 2 }}>
      <Paper variant='outlined' sx={{ width: '100%', maxWidth: 520, p: 3 }}>
        <Stack spacing={2}>
          <Typography variant='h4'>Sign In with Zendesk</Typography>
          <Typography color='text.secondary'>
            KeyTriage is available only for Zendesk teams. Continue with your Zendesk account.
          </Typography>
          ...
          <Typography color='text.secondary'>
            New user? <Link href='/register'>Register with Zendesk</Link>
          </Typography>
          <Typography color='text.secondary'>
